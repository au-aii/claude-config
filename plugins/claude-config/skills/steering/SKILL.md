...
3. **テンプレートからファイル作成**
   ...
   - `${CLAUDE_PLUGIN_ROOT}/skills/steering/templates/requirements.md` → `.steering/[日付]-[機能名]/requirements.md`
   - `${CLAUDE_PLUGIN_ROOT}/skills/steering/templates/design.md` → `.steering/[日付]-[機能名]/design.md`
   - `${CLAUDE_PLUGIN_ROOT}/skills/steering/templates/tasklist.md` → `.steering/[日付]-[機能名]/tasklist.md`
